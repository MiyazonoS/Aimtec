...
namespace Auto_Leveler {
    ...
    public class Program {
        ...
        private static readonly float InvalidSpellConfigurationTextWidth = MiscUtils.MeasureTextWidth(InvalidSpellConfigurationText).First();
        ...
        private static void RenderOnOnPresent() {
            if (!MenuManager.HasValidConfiguration()) {
                Vector2 pos = new Vector2 (BaseX - InvalidSpellConfigurationTextWidth / 2, BaseY);
                //Render.Text(BaseX - InvalidSpellConfigurationTextWidth / 2, BaseY, Color.Red, InvalidSpellConfigurationText);
                Render.Text(InvalidSpellConfigurationText, pos, RenderTextFlags.VerticalCenter, Color.Red);
            }
        }
